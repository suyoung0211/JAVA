...
// 다형성 테스트
//  ㄴ 자식 클래스를 부모 타입 변수에 대입
//  ㄴ 메소드의 인자 또는 리턴값 부모타입으로 하기 : 모든 자식객체는 인자 또는 리턴값이 될 수 있음
...
public class C04PolymorphismTest {
    ...
    private static YourParent makeChild(int type, String name) {
        ...
        // 보모타입으로 물려받은 메소드는 자식 객체 종류 상관없이 실행 가능
        child.setName(name);
        return child;
    }
}
