...
// Map 복습 : 활용예시 일회성으로 데이터를 저장하고 전달하는 목적
...
public class D11MapReview {
    public static void main(String[] args) {
        ...
        // 퀴즈 : test 객체에 저정된 member 를 가져와서, id, name, point 를 출력해보세요. (각각)
        // hint : Object 타입을 직접 출력해보고 casting 하여 출력도 해보세요
        // 1. getter 로 Map 타입 member 가져오기
        Map<String, Object> member = test.getMember();

        // 2. 1번 Map 타입 member 에서 key 값 모두 가져오기
        System.out.println(member.keySet()); // [id, name, point]

        // ⓐ toString 출력은 Object 타입에서 실제 데이터의 타입으로 자동 다운 캐스팅
