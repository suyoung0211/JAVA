...
// java.lang 패키지 소속 : String, System, Integer 와 같은 래퍼 클래스 등등
...
public class B18ArrayTest {
    public static void main(String[] args) {
        ...
        System.out.println("arr1 : " + arr1); // [I@372f7a8d 에서 [I int 배열
        System.out.println("arr2 : " + arr2);
        
        double[] darr1 = { 3.4, 5, 8.88, 1.23, 9.99 };
        double[] darr2 = { 3.4, 5, 8.88, 1.23, 9.99 };
        System.out.println("darr1 : " + darr1); // [D@5674cd4d
        System.out.println("darr1 : " + darr2);
        ...
        // 자바의 배열 크기는 고정된 크기 입니다.
        // 자바의 배열 관련 메소드는 Arrays 클래스의 static 메소드 사용합니다.
        ...
        System.out.println("실수배열 배열요소값 비교 : " + Arrays.equals(darr1, darr2)); // 참조값 비교 false

        // 4. 배열의 복사 : 복사한 새로운 배열의 참조값을 리턴
        int[] newarr1 = Arrays.copyOf(arr1,3);
        // 첫번째 인자 복사할 배열, 두번째 인자는 복사할 갯수
        System.out.println("복사한 배열 : " + Arrays.toString(newarr1));
        
        // 5. 배열의 정렬
        int[] sarr1 = {56, 45, 77, 63, 52};
        Arrays.sort(sarr1);
        System.out.println("정렬 후 sarr1 배열 : " + Arrays.toString(sarr1));

        // Array 의 메소드 중에서 fill, sort 는 리턴타입이 void 이며, 배열의 요소값들을 변경
